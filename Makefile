flags=-I/Users/zaharbessonov/Desktop/Учёба\ в\ институте\ /Информатика/ProjectAsm -ggdb3 -std=c++20 -O0 -Wall -Wextra -Weffc++ -Wc++14-compat -Wmissing-declarations -Wcast-align -Wcast-qual\
...
sources=main.cpp asm_general_funcs.cpp asm_help_funcs.cpp asm_listing_funcs.cpp asm_hashes.cpp ../size_of_file.cpp

all:
	$(CC) $(sources) -o assembler -DASM $(flags)
